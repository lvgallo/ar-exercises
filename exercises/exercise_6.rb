...
@store1.employees.create(first_name: "Gary", last_name: "Jipp", hourly_rate: 51)
@store1.employees.create(first_name: "Andy", last_name: "Lindsay", hourly_rate: 50)

@store2.employees.create(first_name: "Vasiliy", last_name: "Klimkin", hourly_rate: 48)
@store2.employees.create(first_name: "Christian", last_name: "Nally", hourly_rate: 43)
